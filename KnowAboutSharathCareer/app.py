...
class Me:
    ...
    def __init__(self):
        self.openai = openai = OpenAI(api_key=os.environ.get('GOOGLE_API_KEY'), base_url=os.environ.get('GEMINI_BASE_URL'))
        self.name = "Sharath DP"
